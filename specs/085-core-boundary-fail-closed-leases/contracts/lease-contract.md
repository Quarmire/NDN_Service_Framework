...
execution handler immediately before business logic. The handler releases the
lease in a finally-style completion path. PREPARED/COMMITTED use ordinary TTL;
